whole_dot_o:= main.o linked_list.o side_func.o array.o bs_array.o bst.o hash.o avl_tree.o rbt.o
CFLAG:=-Wall -g -fsanitize=undefined -fsanitize=address -fsanitize=leak
whole_dot_h:= basic.h linked_list.h array.h bs_array.h bst.h
all: $(whole_dot_o)
...
bst.o: bst.c bst.h basic.h
	@echo "gcc -c $<\n"
	@gcc -c $(CFLAG) $<

hash.o: hash.c hash.h basic.h
	@echo "gcc -c $<\n"
	@gcc -c $(CFLAG) $<

avl_tree.o: avl_tree.c avl_tree.h basic.h
	@echo "gcc -c $<\n"
	@gcc -c $(CFLAG) $<

rbt.o: rbt.c rbt.h basic.h
	@echo "gcc -c $<\n"
	@gcc -c $(CFLAG) $<
